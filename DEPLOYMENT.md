...
This repo ships a **placeholder** namespace, `@your-username/leaderboard`,
...
package = "@<your-handle>/leaderboard"   # was: @your-username/leaderboard
```

Then update every other reference to the placeholder. For this app that's:
