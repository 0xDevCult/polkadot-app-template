...
async function ensureContractsReady(): Promise<void> {
    ...
    _contractInitPromise = (async () => {
        ...
        // immediately calls `registry.getAddress("@your-username/leaderboard")` as a view, and
        ...
        _contractManager = await ContractManager.fromLiveClient(
            ...
            paseo_asset_hub,
            {
                ...
                libraries: ["@your-username/leaderboard"],
            },
        );
        _contract = wrapContract(_contractManager.getContract("@your-username/leaderboard"));
